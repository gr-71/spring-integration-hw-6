package com.rga.my.shop;

import com.rga.my.shop.domain.Product;
import com.rga.my.shop.integration.ChannelGateway;
...
public class MyShopSpringIntegrationApplication {

	public static void main(String[] args) {
		SpringApplication app = new SpringApplication(MyShopSpringIntegrationApplication.class);
